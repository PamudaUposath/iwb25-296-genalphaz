...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    try {
      const response = await fetch('http://10.0.2.2:8082/donors', {
        method: 'POST',
...
<View style={styles.pickerWrapper}>
  <Picker
    ...
    style={{ width: '100%' }}
    itemStyle={{ height: 50, color: '#000', fontSize: 16 }} // fixes clipping on Android
  >
...
<View style={styles.pickerWrapper}>
  <Picker
    ...
    dropdownIconColor="#d32f2f"
    style={{ width: '100%' }}
    itemStyle={{ height: 50, color: '#000', fontSize: 16 }} // fixes clipping
  >
